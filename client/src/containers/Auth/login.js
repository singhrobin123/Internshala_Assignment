            ...
            <form action="login.php" method="post">
              <div className="modal-body">  
                ...
                <div className="form-group">
                  <input type="email" name="email" id="email" className="form-control " value={props.email || ""} onChange={props.onChangeHandler} placeholder="Enter the email..." required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Please Enter Currect Email.." />
                                </div>
                                {props.emailError &&
                                    <>
                ...
                <div className="form-group">
                  <input type="Password" name="password" value={props.password || ""} onChange={props.onChangeHandler} id="Password" className="form-control " placeholder="Enter Password...... " title="Please Enter Currect Password.." />
                                </div>
                                {props.passwordError &&
                                    <>
                                    <label htmlFor="email" style={{color: "red"}} className="font-weight-bold">{props.message}</label>
